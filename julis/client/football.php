...
$sql_upcoming = "SELECT * FROM events WHERE event_category = 'football' AND event_date > '$current_date' ORDER BY event_date";
$sql_recent = "SELECT * FROM events WHERE event_category = 'football' AND event_date < '$current_date' ORDER BY event_date DESC";
$sql_today = "SELECT * FROM events WHERE event_category = 'football' AND event_date = '$current_date'";
...
<body>
    <div style="color: white;">
        ...
        <div id="team-list">
            <?php
            $sql_teams = "SELECT * FROM teams WHERE team_category = 'football' ORDER BY team_name";
    ...
    <div class="event-container active" id="recent-events" style="color: white;">
        ...
        if ($result_recent->num_rows > 0) {
            ...
            echo "No recent events found with the 'football' category.";
        }
        ?>
    </div>
    ...
    <div class="event-container" id="upcoming-events" style="color: white;">
        ...
        if ($result_upcoming->num_rows > 0) {
            ...
            echo "No upcoming events found with the 'football' category.";
        }
        ?>
    </div>
    ...
    <div class="event-container" id="today-events" style="color: white;">
        ...
        if ($result_today->num_rows > 0) {
            ...
            echo "No events found with the 'football' category for today.";
        }
        ?>
    </div>
