...
$sql_upcoming = "SELECT * FROM events WHERE event_category = 'cricket' AND event_date > '$current_date' ORDER BY event_date";
$sql_recent = "SELECT * FROM events WHERE event_category = 'cricket' AND event_date < '$current_date' ORDER BY event_date DESC";
$sql_today = "SELECT * FROM events WHERE event_category = 'cricket' AND event_date = '$current_date'";
...
<body>
    <div style="color: white;">
        ...
        <div id="team-list">
            <?php
            $sql_teams = "SELECT * FROM teams WHERE team_category = 'cricket' ORDER BY team_name";
    ...
    <div class="event-container active" id="recent-events" style="color: white;">
        ...
        if ($result_recent->num_rows > 0) {
            ...
            echo "No recent cricket event found.";
        }
        ?>
    </div>
    ...
    <div class="event-container" id="upcoming-events" style="color: white;">
        ...
        if ($result_upcoming->num_rows > 0) {
            ...
            echo "No upcoming cricket events found.";
        }
        ?>
    </div>
    ...
    <div class="event-container" id="today-events" style="color: white;">
        ...
        if ($result_today->num_rows > 0) {
            ...
            echo "No events cricket event found for today.";
        }
        ?>
    </div>
